...
- SQL portfolio loss ratios are calculated using earned premium across historical underwriting years, while the pricing model applies a prospective gross written premium assumption. The SQL layer is therefore intended for historical portfolio diagnostics and parameter exploration rather than direct one-to-one validation of the deterministic pricing ratio.
